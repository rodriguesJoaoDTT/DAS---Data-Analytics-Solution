...
def attribute_full_AB(caminho_input):
    ...
    qtd_por_sistema = qtd_register_a(df_usuarios_atributo_b)


    # Tratando colunas de ID

    for df in [df_ativos, df_desligados, df_usuarios_atributo_b]:
    ...
    df_teste_atributo_a = df_usuarios_atributo_b_status_pivot
